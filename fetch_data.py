...
STOCKS = [
    ...
    "VOLV-B.ST", "KINV-B.ST", "HM-B.ST", "SEB-A.ST", "TEL2-B.ST", "BEAMMW-B.ST",
    ...
    "CSPX.L", "EQQQ.DE", "XACT.ST", "XACTHDIV.ST", "SMH", "DFNS.L", "VWRL.L", "IEMG", "IQQH.DE", "GOLD.L",
]
